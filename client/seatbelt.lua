...
function toggleSeatbelt(makeSound, toggle)
    if not harnessOn then
        if toggle == nil then
            if seatbeltOn then
                playSound("unbuckle")
                QBCore.Functions.Progressbar("seatbelt_equip", "Removes the Seatbelt..", 1500, false, true, {
                ...
                playSound("buckle")
                QBCore.Functions.Progressbar("seatbelt_equip", "Putting on Seatbelt..", 1500, false, true, {
                    disableMovement = false,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
